...
<div class="profile" id="company">
    ...
    <div class="strategy">
        ...
        <div class="strategy-paragraph st_text" id="st_text5">/ <span class="strategy-paragraph-text" id="st_text6">寝ない兎は負けない</span></div>
...
<div class="bg_black" id="bg_black">
    ...
    <div class="otaku_text_sp1" id="otaku_text1">
        株式会社おたくとは。<br><br>
        2020年2月、世界最悪のパンデミックが起きました。<br>
        将来の日本をどのようにするべきか、各専門分野の有志が集まり、世界と戦えるチームが私達です。<br><br>
        未来の子供に日本をバトンタッチできるように、私たちは世界と戦い続けます。<br><br>
    ...
    <div class="otaku_text_sp2" id="otaku_text2">
        What is Otaku,<br><br>
        Inc. In February 2020, the world's worst pandemic occurred.<br>
        We are a team of volunteers from various fields of expertise who are ready to fight the world to determine what Japan should be like in the future.<br><br>
...
<div class="sp_div">
    <h2 class="profile-title_sp" id="profile1">Company Profile</h2>
    <div class="profile-subtitle_sp" id="profile2">/ CURRENT BASE IN OSAKA.</div>
    ...
    <div class="strategy_sp">
        ...
        <p class="strategy-description_sp" id="st_text6">裏技、必殺技、抜け道。<br>
        魔法のようにあざやかに課題を解決できる方法は一切存在しません。<br>
        まずはしっか分解、分析をします。いつも解決策は、課題の中にあるからです。<br>
        事業を分解し、すべてを分析し、言語化されていないものを掘り起こし、従業員も理解・納得し、今の時代に合うように明文化していくことが<br>大切だと考えます。
        </p>
    </div>
    ...
    <div id="service_border"></div>
    <div class="profile-title_sp" id="sv_title">Service</div>
    <div class="profile-service_content">
        <ul class="service_sp">
            <li class="service-item"><div class="sv_border" id="sv_border1"></div><div class="service-item_num_sp" id="sv_num1">01</div>
            <div class="sv_text" id="sv_text1"><h3 class="service-item_subtitle">Product Work</h3> <dl ><dt class="service-item_title_sp">プロダクトデザイン・開発</dt>
            <dd class="service-item_desc">オリジナルアイテムをデザインから納品まで一気通貫で制作いたします。</dd></dl></div></li>
            <li class="service-item"><div class="sv_border" id="sv_border2"></div><div class="service-item_num_sp" id="sv_num2">02</div> 
            <div class="sv_text" id="sv_text2"><h3 class="service-item_subtitle">Creative Work</h3> <dl ><dt class="service-item_title_sp">デザイン・開発</dt>
            <dd class="service-item_desc">webデザイン、制作を企業のスタイル</dd></dl></div></li>
            <li class="service-item"><div class="sv_border" id="sv_border3"></div><div class="service-item_num_sp" id="sv_num3">03</div>
            <div class="sv_text" id="sv_text3"><h3 class="service-item_subtitle">Owned Media</h3>
